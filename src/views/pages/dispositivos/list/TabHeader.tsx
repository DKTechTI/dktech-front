...
const TableHeader = (props: TableHeaderProps) => {
  ...
  const handleClickButtonCreateDevice = () => {
    router.push('/dispositivos/criar-dispositivo')
  }
      ...
      <Grid item xs={12} md={10}>
        <Grid container gap={3} justifyContent={'end'}>
          ...
          <Grid item xs={12} md={4} xl={3}>
            <Button fullWidth variant='contained' sx={{ '& svg': { mr: 2 } }} onClick={handleClickButtonCreateDevice}>
